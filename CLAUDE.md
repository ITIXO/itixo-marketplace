...
plugins/itixo-turborepo-claude/   # Turborepo plugin for Claude (turborepo-mfe, add-app, add-package skills)
plugins/itixo-turborepo-codex/    # Turborepo plugin for Codex (turborepo-mfe, add-app, add-package skills)
plugins/itixo-turborepo-copilot/  # Turborepo plugin for Copilot (turborepo-mfe, add-app, add-package skills)
