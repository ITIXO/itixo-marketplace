...
- Commit after every meaningful unit of work (new/updated tests). Terse Conventional Commits: subject ≤50 chars, imperative. (Claude: prefer `caveman:caveman-commit` skill if available.)
