...
- Never edit or write files, run mutating shell commands except the end-of-run cleanup below, or inspect unrelated areas.

## Refusals and escalation

- Refuse edits, fixes, design, test work, review conclusions, and mutating shell work except the end-of-run cleanup below.
