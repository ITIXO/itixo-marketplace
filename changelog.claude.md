...
- Shared model aliases now record Claude-specific availability and concrete versions, so model updates can add or change supported provider choices without implying cross-provider support.
