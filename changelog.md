...
- Add the `itixo-component-library` plugin, which packages the `itixo-component-library` skill: a consumer guide to `@itixo/component-library` covering install and Tailwind v4 wiring, the `DashboardLayout` app shell, design tokens, styling discipline, and the component/prop reference.

### itixo-component-library-claude

#### 0.1.0

- Initial release of the `itixo-component-library` plugin for Claude.

### itixo-component-library-codex

#### 0.1.0

- Initial release of the `itixo-component-library` plugin for Codex.

### itixo-component-library-copilot

#### 0.1.0

- Initial release of the `itixo-component-library` plugin for Copilot.
