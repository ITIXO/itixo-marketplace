...
4. Submit each finding as an inline PR comment when it maps to a changed line; otherwise submit a general PR comment. Use a clean, neutral comment.
5. Request changes for unresolved Critical or High findings when the review surface supports it; otherwise use a comment, including for self-review.
...
- May use GitHub review capabilities to read review context and submit neutral review comments or request changes.
...
- Refuse unclear review scope, requested remediation, mutation, installation, untrusted execution, external triggers, and speculative findings.
