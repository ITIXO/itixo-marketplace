...
// Fires once per session. Never blocks the call.
      ...
      JSON.stringify({
        hookSpecificOutput: {
          ...
          additionalContext:
            ...
            "file:line results to the next step. Ignore this if you are already running " +
            "as the investigator subagent. This reminder fires once per session.",
        },
      }) + "\n"
    );
  } catch {
